...
const LS_CACHE_PATH = path.join(__dirname, '_ls.cache')
const CUE_CACHE_PATH = path.join(__dirname, '_cue.cache')

{
  ...
  try {
    ...
    console.log(`ls-cache created at ${LS_CACHE_PATH}`)
    console.log()
  }
  ...
  try {
    ...
    console.log(`cue-cache created at ${CUE_CACHE_PATH}`)
    console.log()
  }
...
app.get('/cue', (req, res) => res.sendFile(CUE_CACHE_PATH))
